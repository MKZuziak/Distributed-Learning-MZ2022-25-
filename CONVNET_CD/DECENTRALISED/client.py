...
def main() -> None:
    ...
    print('New client loaded, training set shape: {x_train} and {y_train}, {x_test}, {y_test}'.format(x_train=x_train.shape, y_train=y_train.shape, x_test=x_test.shape, y_test=y_test.shape))
    # Start Flower client
...
def load_partition(idx: int):
    ...
    #For now, load the whole dataset
    #TODO: Load partitions of the data, not the whole dataset
    num_classes = 10
